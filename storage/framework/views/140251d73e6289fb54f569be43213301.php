...
<head>
    ...
    <title>Admin – <?php echo $__env->yieldContent('title','Dashboard'); ?> | RasaNusantara</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active':''); ?>"><span class="icon">📊</span> Dashboard</a>

        <div class="sidebar-section">Konten</div>
        <a href="<?php echo e(route('admin.resep.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.resep.*') ? 'active':''); ?>"><span class="icon">🍽</span> Kelola Resep</a>
        <a href="<?php echo e(route('admin.kategori.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.kategori.*') ? 'active':''); ?>"><span class="icon">🏷</span> Kelola Kategori</a>

        <div class="sidebar-section">Pengguna</div>
        <a href="<?php echo e(route('admin.pengguna.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.pengguna.*') ? 'active':''); ?>"><span class="icon">👥</span> Kelola Pengguna</a>
        <a href="<?php echo e(route('admin.ulasan.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.ulasan.*') ? 'active':''); ?>"><span class="icon">💬</span> Kelola Ulasan</a>

        <div class="sidebar-section">Laporan</div>
        <a href="<?php echo e(route('admin.statistik')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.statistik') ? 'active':''); ?>"><span class="icon">📈</span> Statistik</a>
    </nav>
    <div class="sidebar-footer">
        <div style="font-weight:700;margin-bottom:4px;"><?php echo e(auth()->user()->name); ?></div>
        <form method="POST" action="<?php echo e(route('logout')); ?>"><?php echo csrf_field(); ?><button type="submit" style="background:none;border:none;color:var(--cream-semi);cursor:pointer;font-size:12px;padding:0;">→ Logout</button></form>
        <a href="<?php echo e(route('beranda')); ?>" style="font-size:12px;color:var(--cream-semi);display:block;margin-top:6px;">← Ke Beranda</a>
    </div>
</aside>
<div class="main">
    <div class="topbar">
        <div class="topbar-title"><?php echo $__env->yieldContent('title','Dashboard'); ?></div>
        <div class="topbar-user"><span>Halo, <?php echo e(auth()->user()->name); ?></span><span class="badge badge-gold">Admin</span></div>
    </div>
    <div class="content">
...
<?php /**PATH C:\laragon\www\RasaNusantara\resources\views/layouts/admin.blade.php ENDPATH**/ ?>